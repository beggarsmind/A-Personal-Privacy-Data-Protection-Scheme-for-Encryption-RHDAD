    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="ConfirmVerify.jsp">
          <table width="598" border="1" align="center" cellpadding="10" cellspacing="0">
           
            <tr>
              <td class="style1 style4"><span class="style27">File Name :- </span></td>
            ...
            <tr>
              ...
              <td><input name="Submit" type="submit" class="style1" value="Verify" /></td>
            </tr>
          </table>
          </form>
          <p>&nbsp;</p>
