...
input[type=text],input[type=password],input[type=email], input[type=mobile],input[type=dob],input[type=gender],
input[type=pincode],input[type=location], input[type=select] { 
width=100%;
 padding:6px 2px;
 margin:8px 0;
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>END DATA OWNER Register </span></h2>
          <p>&nbsp;</p>
          <form action="DU_RegisterAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
            <label for="name"><br />
              <span class="style2">END DATA OWNER Name (required)<br />
              </span></label>
            <p class="style2">
            ...
            <p class="style2">
              <input  type="mobile" id="mobile" name="mobile" class="text" />
            </p>
            <span class="style2">
            <label  type="address" for="address">Your Address<br />
            </label>
            </span>
            <p class="style2">
            ...
            <p class="style2">
              <input type="dob" id="dob" name="dob" class="text" />
            </p>
            <span class="style2">
            ...
            <p class="style2">
              <select type="select" id="s1" name="gender" class="text">
            ...
            <p class="style2">
              <input type="pincode" id="pincode" name="pincode" class="text" />
            </p>
            <span class="style2">
            <label  type="location" for="location">Enter Location (required)<br />
            </label>
            </span>
            <p class="style2">
