...
.style23 {color: #0d6887}
.style24 {font-size: 14px; font-weight: bold; color: #0d6887; }
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="615" border="1.5" cellpadding="0" cellspacing="0" align="center">
            <tr>
              <td width="37" height="31" bgcolor="#00FF00"><div align="center" class="style22 style23"> ID </div></td>
              <td width="76" bgcolor="#00FF00"><div align="center" class="style24"> Name </div></td>
              <td width="97" bgcolor="#00FF00"><div align="center" class="style24">File Name </div></td>
              <td width="131" bgcolor="#00FF00"><div align="center" class="style24">Missmatch Key </div></td>
              <td width="122" bgcolor="#00FF00"><div align="center" class="style24">Date &amp; Time</div></td>
              <td width="138" bgcolor="#00FF00"><div align="center" class="style24">Attack Type </div></td>
            </tr>
            <%
