...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="PKG_Main.jsp">PKG</a></li>
          <li class="active"><a href="PKG_Login.jsp"> Logout </a><a href="about.html"></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome:: PKG</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="img"><img src="images/img1.jpg" width="217" height="360" alt="" class="fl" /></div>
      ...
      <div class="sidebar">
       <div class="gadget">
        ...
        <div class="clr"></div>
        <ul class="sb_menu">
          <li><strong><a href="PKG_Main.jsp">Home</a></strong></li>
		   <li><strong><a href="PKG_View_All_Files.jsp">View Files and Generate Key</a></strong></li>
		    <li><strong><a href="PKG_Login.jsp">Logout</a></strong></li>
        </ul>
       </div>
      </div>
      <div class="clr"></div>
