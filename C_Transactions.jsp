...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Transactions</span> Based On Keywords </h2>
          <p>&nbsp;</p>
          <table width="615" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
            <tr>
              ...
              <td width="119" bgcolor="#FFFF00"><div align="center" class="style27">Keyword </div></td>
              <td width="161" bgcolor="#FFFF00"><div align="center" class="style27">Date &amp; Time</div></td>
            </tr>
            <%
	...
	try 
	{
	    		...
	    		String cname=(String)application.getAttribute("csname1") ;
			...
			while ( rs.next() )
			{
				...
				%>
            <tr>
              <td height="29"><div align="center" class="style25 style23"><%=i%></div></td>
              <td><div align="center" class="style25 style23"><%=s3%></div></td>
              <td><div align="center" class="style25 style23"><%=s4%></div></td>
              <td><div align="center" class="style25 style23"><%=s5%></div></td>
            </tr>
            <%
			}
		connection.close();
