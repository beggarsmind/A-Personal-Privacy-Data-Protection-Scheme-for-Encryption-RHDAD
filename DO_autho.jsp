    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p class="style2">Welcome <%=application.getAttribute("doname")%>		  </p>
          <p class="style2">You Are <span class="style3">Not Authorized</span> <span class="style5">Please Wait For CLOUD SERVICE PROVIDERS To Authorize !          </span></p>
          <p class="style6">&nbsp;</p>
          <p class="infopost">&nbsp;</p>
        </div>
      </div>
