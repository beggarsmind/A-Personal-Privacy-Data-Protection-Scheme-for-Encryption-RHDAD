...
<head>
<title>CLOUD SERVICE PROVIDERS Main</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="C_Main.jsp">CLOUD SERVICE PROVIDERS</a></li>
          <li class="active"><a href="C_Login.jsp"><span>Logout </span></a></li>
          <li></li>
        </ul>
      </div>
      <div class="clr"></div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <li><a href="C_Main.jsp">Home</a></li>
		      <li><a href="C_UserAutho.jsp">View and Authorize Users</a></li>
          <li><a href="C_OwnerAutho.jsp">View and Authorize Owners</a></li>
          <li><a href="C_ViewFiles.jsp">View Files</a></li>
          <li><a href="C_Transactions.jsp">View All Search Transactions</a></li>
		 <li><a href="C_File_Transactions.jsp">View All File Transactions</a></li>
		
          <li><a href="C_TopSearched.jsp">View All Top Searched</a></li>
          <li><a href="C_Attackers.jsp">View Attackers</a> </li>
      
          <li><a href="C_GrantSearch.jsp">Search Requests</a></li>
         
          <li><a href="C_View_TimeDelay.jsp">View Time Delay</a></li>
		  <li><a href="C_View_Throughput.jsp">View Throughput</a></li>
