...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="PKG_Login.jsp">PKG</a><a href="about.html"></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>PKG  Login </span></h2>
          <p><img src="images/Login.jpg" width="158" height="158" /></p>
          <form action="PKG_Authentication.jsp" method="post" id="leavereply">
<fieldset>
              <legend>Login </legend>            
<label for="name"><br />
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <li><strong><a href="DU_Login.jsp">END DATA OWNER </a></strong></li>
